...
HD_PWD='C:/Users/Colton/Vivado/Digital_Clock/Digital_Clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevseg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevseg.tcl -notrace
