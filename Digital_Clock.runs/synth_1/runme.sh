...
HD_PWD='C:/Users/Colton/Vivado/Digital_Clock/Digital_Clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sevseg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sevseg.tcl
